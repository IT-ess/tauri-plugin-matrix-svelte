...
export const createMatrixRequest = {
  ...
  getRoomMembers: (
    payload: GetRoomMembersRequest["payload"],
  ): GetRoomMembersRequest => ({
    event: "getRoomMembers",
    payload,
  }),
  ...
  getUserProfile: (
    payload: GetUserProfileRequest["payload"],
  ): GetUserProfileRequest => ({
    event: "getUserProfile",
    payload,
  }),
  ...
  resolveRoomAlias: (
    payload: ResolveRoomAliasRequest["payload"],
  ): ResolveRoomAliasRequest => ({
    event: "resolveRoomAlias",
    payload,
  }),
  ...
  */
  ...
  sendTypingNotice: (
    payload: SendTypingNoticeRequest["payload"],
  ): SendTypingNoticeRequest => ({
    event: "sendTypingNotice",
    payload,
  }),
  ...
  readReceipt: (
    payload: ReadReceiptRequest["payload"],
  ): ReadReceiptRequest => ({
    event: "readReceipt",
    payload,
  }),
  ...
  fullyReadReceipt: (
    payload: FullyReadReceiptRequest["payload"],
  ): FullyReadReceiptRequest => ({
    event: "fullyReadReceipt",
    payload,
  }),
  ...
  toggleReaction: (
    payload: ToggleReactionRequest["payload"],
  ): ToggleReactionRequest => ({
    event: "toggleReaction",
    payload,
  }),
  ...
  redactMessage: (
    payload: RedactMessageRequest["payload"],
  ): RedactMessageRequest => ({
    event: "redactMessage",
    payload,
  }),
